...
//       // Now insert the medicine using the UUID
//       const { data, error } = await supabase
//         .from('medicines')
//         .insert([{
//           user_id: userData.id, // Use the UUID, not user.id
...
//       { text: 'OTC (Over-the-counter)', onPress: () => updateField('medicine_type', 'otc') },
//       { text: 'Prescription', onPress: () => updateField('medicine_type', 'prescription') },
//       { text: 'Herbal/Natural', onPress: () => updateField('medicine_type', 'herbal') },
//       { text: 'Supplement', onPress: () => updateField('medicine_type', 'supplement') },
...
//       { text: 'Injections', onPress: () => updateField('unit_type', 'injections') },
//       { text: 'Cancel', style: 'cancel' }
//     ]);
//   };
...
//       case 'herbal': return 'Herbal/Natural';
...
//                   onPress={() => updateField('current_quantity', Math.max(1, formData.current_quantity - 1))}
//                 >
//                   <Ionicons name="remove" size={20} color="#007AFF" />
//                 </TouchableOpacity>
//                 <Text style={styles.quantityText}>{formData.current_quantity}</Text>
//                 <TouchableOpacity
//                   style={styles.quantityButton}
//                   onPress={() => updateField('current_quantity', formData.current_quantity + 1)}
//                 >
...
//               onChangeText={(value) => updateField('dosage_instructions', value)}
...
//         {/* Add some bottom padding to account for potential keyboard/navigation */}
...
//         <DateTimePicker
//           value={formData.manufacture_date ? new Date(formData.manufacture_date) : new Date()}
//           mode="date"
//           display="default"
//           onChange={(event, date) => {
//             setShowManufacturePicker(false);
//             if (date) {
//               updateField('manufacture_date', date.toISOString().split('T')[0]);
//             }
//           }}
//         />
//       )}
